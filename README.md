...
Minimal Electron control app that opens and monitors a real Google Chrome window, keeps a persistent Chrome profile for this app, refreshes on demand or on an interval, and alerts when page text is found or missing after a page load.
